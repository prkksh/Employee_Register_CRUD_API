...
class EmployeeControllerTest {
    ...
    @Test
    public void requesting_employees_list_should_return_all_employees() {
    ...
    @Test
    public void searching_for_existent_employee_by_id_should_return_matching_employee() throws EmployeeNotFoundException {
        Employee employee1 = new Employee("Adam","Smith","SE",50000);
    ...
    @Test
    public void searching_for_non_existent_employee_by_id_should_throw_exception() throws EmployeeNotFoundException {
        Employee employee1 = new Employee("Adam","Smith","SE",50000);
        Mockito.when(employeeRepository.findById(1l)).thenReturn(Optional.of(employee1));
    ...
    @Test
    public void create_employee_should_call_save_1_time() {
        Employee employee1 = new Employee("Adam","Smith","SE",50000);
    ...
    @Test
    public void update_existent_employee_by_id_should_return_expected_object() throws EmployeeNotFoundException {
        Employee employee1 = new Employee("Adam","Smith","SE",50000);
    ...
    @Test
    public void update_non_existent_employee_by_id_should_throw_exception() throws EmployeeNotFoundException {
    ...
    @Test
    public void delete_existent_employee_by_id_should_delete_employee() throws EmployeeNotFoundException {
        Employee employee = new Employee("Adam","Smith","SE",50000);
    ...
    @Test
    public void delete_non_existent_employee_by_id_should_throw_exception() throws EmployeeNotFoundException {
